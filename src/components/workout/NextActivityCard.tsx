...
export function NextActivityCard({ nextActivity, isCompleted }: NextActivityCardProps) {
  ...
  return (
    <section className="demo-card rise-in p-4 border border-line bg-[rgba(255,255,255,0.01)] flex items-center justify-between gap-4">
      ...
      {nextActivity && (
        <div className="flex-shrink-0 flex items-center gap-1 bg-[rgba(0,240,255,0.05)] border border-line rounded-xl py-1.5 px-2.5 text-xs text-lagoon">
